...
public class AccountServiceArrayListMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("6.AccountServiceArrayList야은행계좌들 중에 계좌주이름이 AIM인 계좌들반환해줘");
		findAccounts=accountServiceArrayList.findByName("AIM");
		for (Account account : findAccounts) {
			account.print();
		}
		
		System.out.println("7.AccountServiceArrayList야1111번계좌 50000원 출금한후에 Account객체반환해줘");
