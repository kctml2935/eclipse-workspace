...
public class MemberMethod {
	 ...
	 *   - 매개변수  : 문자열,정수(2개) 
	 	 - 구현내용  : 인자로받은데이타 2개출력 
	 */
	public void method4(String s1, int no) {
		System.out.println(this.s1 + " "+this.no);
	}
	/*
	 * 메쏘드선언
	 *   - 메쏘드이름: method5
	 ...
	 *   - 구현내용  : 인자로받은데이타 3개출력 
	 */
	public void method5(String s1, String s2 ,int no) {
		System.out.println(this.s1 + " " + this.s2 + " " + this.no);
	}
