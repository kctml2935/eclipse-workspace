...
class AbstractChild extends AbstractParent{
	...
	@Override
	public void method2() {
		System.out.println("AbstractChild에서 AbstractParent의 추상메쏘드 method2()재정의[implement(구현)]");
...
public class AbstractParentChildMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		AbstractParent abstractParent2 = new AbstractChild();
		abstractParent2.method1();
		abstractParent2.method2();
